...
import numpy as np
from datasheet import BirdsEyeView
import colorsys
...
# getting Video
cap = cv2.VideoCapture("demo1.mp4") #0 and 1 webcam
...
while True:
    ...
    ptime = ctime
    cv2.putText(frame, f"By Syed Rizwan , FPS: {fps}", (30, 40), 4, cv2.FONT_HERSHEY_PLAIN, (0, 225, 0), 2)
